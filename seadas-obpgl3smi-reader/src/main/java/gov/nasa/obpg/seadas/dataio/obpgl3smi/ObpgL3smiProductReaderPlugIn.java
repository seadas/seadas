...
public class ObpgL3smiProductReaderPlugIn implements ProductReaderPlugIn {
    ...
    */
    private static final String DEFAULT_FILE_EXTENSION_L3SMI = ".L3m";
    public static final String READER_DESCRIPTION = "NASA Ocean Color (OBPG) L3 SMI Products";
    public static final String FORMAT_NAME = "NASA-OBPG-L3SMI";
	...
	*/
    ...
    public ProductReader createReaderInstance() {
        return new ObpgL3smiProductReader(this);
    }
    ...
    private File getInputFile(Object input) {
        try {
            return ObpgL3smiUtils.getInputFile(input);
