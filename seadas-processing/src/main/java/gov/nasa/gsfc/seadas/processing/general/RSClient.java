...
public class RSClient {
    final static ClientConfig config = new DefaultClientConfig();
    final static Client client = Client.create(config);
    ...
    public static boolean uploadFile(String[] filesToUpload) {
