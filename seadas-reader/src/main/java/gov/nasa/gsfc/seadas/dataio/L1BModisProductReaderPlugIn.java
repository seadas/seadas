...
public class L1BModisProductReaderPlugIn implements ProductReaderPlugIn {
    ...
    private static final String DEFAULT_FILE_EXTENSION_L1B_HKM = ".L1B_HKM";
    private static final String DEFAULT_FILE_EXTENSION_L1B_QKM = ".L1B_QKM";

    public static final String READER_DESCRIPTION = "MODIS L1B Products";
    public static final String FORMAT_NAME = "MODIS-L1B";
    ...
    public String[] getDefaultFileExtensions() {
        ...
        return new String[]{
                ...
                DEFAULT_FILE_EXTENSION_L1B_HKM,
                DEFAULT_FILE_EXTENSION_L1B_QKM
        };
    }
