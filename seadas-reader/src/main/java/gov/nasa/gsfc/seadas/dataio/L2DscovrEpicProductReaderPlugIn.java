...
public class L2DscovrEpicProductReaderPlugIn implements ProductReaderPlugIn {
    ...
    public static final String READER_DESCRIPTION = "DSCOVR EPIC L2 Products";
    public static final String FORMAT_NAME = "DSCOVER-L2";
