    ...
    private void addFlagsAndMasks(Product product) {
        ...
        if (QFBand != null) {
            ...
            product.getMaskGroup().add(Mask.BandMathsType.create("AtmWarn", "Atmospheric correction warning",
                                                                 ...
                                                                 Color.MAGENTA, 0.2));
            product.getMaskGroup().add(Mask.BandMathsType.create("BOB", "Atmospheric correction warning for BOB",
                                                                 product.getSceneRasterWidth(),
                                                                 product.getSceneRasterHeight(), "QF3_VIIRSOCCEDR && 0x08 ==  0x08",
                                                                 Color.RED, 0.2));
        ...
        if (QFBand != null) {
            ...
            product.getMaskGroup().add(Mask.BandMathsType.create("Ocean", "Ocean",
                                                                 product.getSceneRasterWidth(),
                                                                 product.getSceneRasterHeight(), "QF4_VIIRSOCCEDR && 0x00 == 0x00",
                                                                 Color.BLUE, 0.2));
            product.getMaskGroup().add(Mask.BandMathsType.create("CoastalWater", "Coastal Water mask",
                                                                 product.getSceneRasterWidth(),
                                                                 product.getSceneRasterHeight(), "QF4_VIIRSOCCEDR && 0x01 == 0x01",
                                                                 Color.GRAY, 0.2));
            product.getMaskGroup().add(Mask.BandMathsType.create("InlandWater", "Inland water mask",
                                                                 product.getSceneRasterWidth(),
                                                                 product.getSceneRasterHeight(), "QF4_VIIRSOCCEDR && 0x02 == 0x02",
                                                                 Color.DARK_GRAY, 0.2));
...
//            flagCoding.addFlag("ChlFail", 0x08, "No Chlorophyll retrieval possible");
//            flagCoding.addFlag("LowChl", 0x10, "Chlorophyll < 1 mg m^-3");
//            flagCoding.addFlag("ModChl", 0x18, "Chlorophyll between 1 and 10 mg m^-3");
//            flagCoding.addFlag("HighChl", 0x18, "Chlorphyll > 10 mg m^-3");
//            flagCoding.addFlag("CarderEmp", 0x20, "Carder Empirical algorithm used");
//            flagCoding.addFlag("UnpackPig", 0x40, "Phytoplankton with packaged pigment");
//            flagCoding.addFlag("WtPigGlobal", 0x60, "Weighted packaged pigment - global");
//            flagCoding.addFlag("WtPigFull", 0x80, "Weighted fully packaged pigment");
//            flagCoding.addFlag("FullPackPig", 0xA0, "Phytoplankton with fully packaged pigment");
//            flagCoding.addFlag("NoOCC", 0xE0, "No ocean color chlorphyll retrieval");
