...
public class ObpgGeonav {
    ...
    float[] sena = new float[MAX_SEAWIFS_PIXELS];
    float[] senz = new float[MAX_SEAWIFS_PIXELS];
    float[] sola = new float[MAX_SEAWIFS_PIXELS];
    float[] solz = new float[MAX_SEAWIFS_PIXELS];
    float[] xlat = new float[MAX_SEAWIFS_PIXELS];
    float[] xlon = new float[MAX_SEAWIFS_PIXELS];
    ...
    float[][] latitudes;
    float[][] longitudes;
    int numPixels = LAC_PIXELS_PER_SCAN;
    int numScanLines;
    float[][] sensorAzimuths;
    float[][] sensorZeniths;
    float[][] solarAzimuths;
    float[][] solarZeniths;
...
*/
        ...
        numScanLines = getNumberScanLines(ncFile);
